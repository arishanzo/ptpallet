...
const HeroSection = () => {
 ...
 <section class="relative bg-red-600  py-12  sm:py-16 lg:pt-20    lg:pb-36" id='home'>
        ...
        <div class="mx-auto sm:px-6 md:py-12 py-4 lg:px-8 w-[80%] ">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 sm:gap-y-20 xl:grid-cols-4 items-center">
                <div class="text-center xl:col-span-2 lg:text-left lg:px-0 md:max-w-[600px]" >
                    <div class="max-w-full  md:p-0 mx-auto sm:max-w-md md:max-w-full">
    ...
    <a href="/" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-100 border-red-100 border-2 border-dotted rounded-full " role="alert">
     ...
     <h1 class="text-2xl  justify-start font-bold  leading-tight text-gray-100 md:pt-8 pb-2 md:pb-8 sm:text-5xl lg:text-5xl lg:leading-tight font-pj">PT. Indonesia Pallet Logistik</h1>
                 
 
                        <h1 class="text-2xl justify-start font-semibold  leading-tight text-red-100  pb-2 md:pb-8 sm:text-2xl lg:text-2xl lg:leading-tight font-pj">The Best Solution Business Partner Support</h1>
                    <p className=" px-4 font-sans sm:p-0  text-red-200 py-3.5 md:max-w-[480px] md:mb-12 md:text-sm  lg:mb-5 lg:text-md text-justify">
  ...
  <div class=" overflow-hidden rounded-xl text-center justify-end item-end shadow-lg">
    <img
