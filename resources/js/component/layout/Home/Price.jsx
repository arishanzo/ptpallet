...
const Price = () => {
    ...
    <div className="mx-auto grid max-auto  md:max-w-[1700px]  md:px-16  sm:grid-cols-12  md:grid-cols-12 ">
      ...
      <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-200 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
        ...
        <h5 className=" text-2xl md:text-5xl font-bold leading-normal tracking-tight dark:text-white md:max-w-2xl sm:text-2xl xl:text-6xl">Harga <span className='text-purple-800 font-extrabold  dark:text-purple-500 '>Website Kami</span></h5>
      </div>
      <div className="content-center text-center sm:pl-16 md:p-8 md:justify-self-start sm:text-sm sm:text-start sm:col-span-4 md:col-span-6 md:text-start">
        ...
        <h3 className=" p-8 font-sans sm:p-0 text-gray-500 dark:text-gray-400 py-3.5 md:max-w-[650px] md:mb-12 md:text-lg  lg:mb-5 lg:text-xl">Kami menyediakan solusi lengkap untuk kebutuhan digital Anda melalui Harga pembuatan website yang profesional, inovatif, dan terfokus pada hasil. Berikut adalah deskripsi Price yang kami tawarkan:</h3>
      </div>
