...
const Story = () => {
    ...
    <div class="mx-auto  px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">Perjalanan Kami Sejak Tahun 2022
            </h2>
        ...
        <ul class="mx-auto mt-12 grid  md:max-w-[1500px] grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
            <li class="flex-start group relative flex lg:flex-col">
                ...
                <div
                    class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-300 bg-gray-50 transition-all duration-200 group-hover:border-gray-900 group-hover:bg-purple-900">
                   <FaCode />
                </div>
