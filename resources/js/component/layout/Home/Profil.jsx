...
const Profil = () => {
    ...
    return (
      ...
      <section class="relative   lg:pt-20   overflow-y-hidden " id='profil'>
        <div class="mx-auto sm:px-6 md:py-12 lg:px-8 md:max-w-[80%] p-8">
  ...
  <div class="absolute bottom-0 top-32 md:top-56 left-0 w-[500px] bg-white ">
    ...
    <p className="mb-4 md:mt-4 pl-2 text-xs font-sans sm:p-0 text-gray-500 dark:text-gray-400 md:max-w-[450px] max-w-xs md:mb-12 md:text-lg  lg:mb-5 lg:text-xl text-justify">
        ...
        <span className="text-sm text-center px-4 py-1.5 mr-3 font-medium">Produsen Pallet Kayu Berkualitas</span> 
                        ...
                        <h1 class="text-3xl justify-start font-bold  leading-tight text-gray-900  pb-2 md:pb-8 sm:text-4xl lg:text-4xl lg:leading-tight font-pj">Tentang Kami PT. Indonesia Pallet Logistik</h1>
                    <p className="mb-4 px-4 font-sans sm:p-0 text-gray-500 dark:text-gray-400 py-3.5 md:max-w-[650px] md:mb-12 md:text-sm  lg:mb-5 lg:text-xl text-justify">
                   PT. Indonesia Pallet Logistik adalah perusahaan terkemuka di Indonesia yang berfokus pada penjualan dan penyewaan pallet kayu serta pallet plastik berkualitas tinggi untuk berbagai kebutuhan industri. Kami melayani permintaan dari sektor logistik, manufaktur, pergudangan, ekspor-impor, hingga distribusi retail. Dengan pengalaman bertahun-tahun dan komitmen terhadap kualitas, PT. Indonesia Pallet System menyediakan solusi pallet yang kuat, tahan lama, dan sesuai standar internasional untuk menunjang efisiensi operasional bisnis Anda. Jika Anda mencari 
