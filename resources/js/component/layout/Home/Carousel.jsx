...
<div key={item.id} className="hidden max-w-md mr-5  dark:shadow-2xl  p-8 flex flex-wrap mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
